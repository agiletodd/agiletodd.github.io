...
This blog is intended to be a melting pot of contributions from the Scrum community. This blog **is not** the definitive guide for Scrum! The Scrum guide was developed by Ken Schwaber and Jeff Sutherland and can be found at [http://www.scrumguides.org/](http://www.scrumguides.org/). **This is** a place for methodology, practices, principles, thoughts, a hypothesis and/or any surrounding material that may advance an implementation of Scrum.

Want to contribute or see the amazing contributors? Check us out on GitHub at [https://github.com/agiletodd/agiletodd.github.io](https://github.com/agiletodd/agiletodd.github.io)
